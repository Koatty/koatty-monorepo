...
### [2.0.8](https://github.com/koatty/koatty_core/compare/koatty-core@2.0.8-0...koatty-core@2.0.8) (2025-11-02)

### [2.0.8-0](https://github.com/koatty/koatty_core/compare/koatty-core@2.0.7...koatty-core@2.0.8-0) (2025-10-31)

### [2.0.7](https://github.com/koatty/koatty_core/compare/koatty-core@2.0.6...koatty-core@2.0.7) (2025-10-31)

### [2.0.6](https://github.com/koatty/koatty_core/compare/koatty-core@2.0.5...koatty-core@2.0.6) (2025-10-30)

### [2.0.5](https://github.com/koatty/koatty_core/compare/koatty-core@2.0.4...koatty-core@2.0.5) (2025-10-30)

### [2.0.4](https://github.com/koatty/koatty_core/compare/koatty-core@2.0.3...koatty-core@2.0.4) (2025-10-30)
...
- **koatty-trace:** 修复 ESLint 错误和测试 mock 问题 ([b24e1f9](https://github.com/koatty/koatty_core/commit/b24e1f9dcc55c64f5d97f3ca01bc53161e7bdb7c))
...
- **scripts:** 修复 monorepo 中 tag 冲突问题 ([d2602bc](https://github.com/koatty/koatty_core/commit/d2602bcc8c245e6f2137a678ec0e5e2fd6ef673a))
- **scripts:** 增强 release 脚本的验证和调试信息 ([2e0db49](https://github.com/koatty/koatty_core/commit/2e0db499234bd4f132bbfc65559105fd9f98f926))
- 解决依赖问题以支持 Koa 3.0 升级 ([30cf0b5](https://github.com/koatty/koatty_core/commit/30cf0b53ed032c7de5ea24b4c2ed965e8d4948df))
...
- **GraphQL**: 添加 GraphQL 协议支持
  ...
  - 实现 GraphQL 特定的元数据处理
  - 添加完整的 GraphQL 上下文测试用例

- **Utils**: 完善工具函数测试覆盖率
  - 新增`test/utils.test.ts`测试文件
  - 实现 100%测试覆盖率（语句、分支、函数、行）
...
- fix: appdebug 逻辑 ([1fc2fce](https://github.com/koatty/koatty_core/commit/1fc2fce))
...
- fix: appDebug 逻辑 ([f477a6a](https://github.com/koatty/koatty_core/commit/f477a6a))
- fix: appDebug 逻辑 ([f35e785](https://github.com/koatty/koatty_core/commit/f35e785))
...
- fix: env 判断逻辑 ([95da7d8](https://github.com/koatty/koatty_core/commit/95da7d8))

## <small>1.11.1 (2025-01-14)</small>

- build: v1.11.1 ([68e19a0](https://github.com/koatty/koatty_core/commit/68e19a0))
- fix: app.env 逻辑修改 ([163f105](https://github.com/koatty/koatty_core/commit/163f105))
...
- refactor: 优化 ctx 创建，更加贴合 koa 的执行逻辑 ([6acfecf](https://github.com/koatty/koatty_core/commit/6acfecf))
...
- feat: ctx 增加 requestParam、requestBody ([165e2de](https://github.com/koatty/koatty_core/commit/165e2de))
...
- refactor: KoattyMetadata 移除依赖 ([2843080](https://github.com/koatty/koatty_core/commit/2843080))
...
- 🐞 fix: ws 参数传递错误 ([8a18e2d](https://github.com/koatty/koatty_core/commit/8a18e2d))
...
- 🐞 fix: options 移入各自组件 ([f9ca1b3](https://github.com/koatty/koatty_core/commit/f9ca1b3))
...
- 🔧 build: husky 配置 ([142e315](https://github.com/koatty/koatty_core/commit/142e315))
...
- refactor: 适配 app.callback ([9147851](https://github.com/koatty/koatty_core/commit/9147851))
...
- 🐞 fix:修复 http status 404 问题 ([099f3a8](https://github.com/koatty/koatty_core/commit/099f3a8))
- 🐞 fix:修复 res 参数错误 ([a6902a8](https://github.com/koatty/koatty_core/commit/a6902a8))
...
- ✨ feat:增加 logger 属性 ([7238bfe](https://github.com/koatty/koatty_core/commit/7238bfe))
...
- 🐞 fix:支持 grpc metadata ([79c5345](https://github.com/koatty/koatty_core/commit/79c5345))
...
- 🐞 fix:setMetaData 支持属性保护 ([1281ea5](https://github.com/koatty/koatty_core/commit/1281ea5))
